...
- Docker e XAMPP  
- Microsoft Azure  
- DevOps: Ubuntu server, Windows Server e nginx


## Projetos
- BarberCloud [Backend](https://github.com/alonesch/api-barbearia-portifolio) e [Frontend](https://github.com/alonesch/barbearia-portifolio):
